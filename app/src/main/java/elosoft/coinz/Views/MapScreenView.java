...
public class MapScreenView extends Fragment implements LocationEngineListener {
    ...
    private void initMap() {
        ...
        mapView.getMapAsync((MapboxMap mapboxMap) -> {
            ...
            if (checkMapPermissions(appContext)){
                ...
                locationComponent.activateLocationComponent(appContext);
    ...
    private void asyncFetchMapIcons(MapboxMap mapboxMap) {
        ...
        FireStoreAPI.getInstance().getUserCollectableCoinz(currentUser, task -> {
            ...
            addCoinzToMap(mapboxMap, coinz, appContext);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        collectCoinzButton.setOnClickListener(v -> {
            Button collectCoinzButton1 = view.findViewById(R.id.collect_coinz_button);
            collectCoinzButton1.setVisibility(View.GONE);
            mapView.setVisibility(View.VISIBLE);
            String currentUser = LocalStorageAPI.getLoggedInUserName(appContext);
    ...
    private void slideCollectButtonUp(Button collecetCoinzButton) {
        if (!buttonVisble) {
            ...
            Animation slide_up = AnimationUtils.loadAnimation(appContext,
                    R.anim.slide_up);
    ...
    private void slideCollectButtonDown(Button collecetCoinzButton) {
        if (buttonVisble) {
            ...
            Animation slide_down = AnimationUtils.loadAnimation(appContext,
                    R.anim.slide_down);
